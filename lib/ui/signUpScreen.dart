...
class _SignUpScreenState extends State<SignUpScreen> {
        ...
        builder: (context, constraints) {
          if (constraints.maxWidth > 600) {
                      ...
                      Stack(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: Lottie.asset(
                                  'assets/lottie/bitcointouch.json',
                                  fit: BoxFit.fill),
                            ),
                          )
                        ],
            ...
            return Column(
              ...
              children: [
                // const SizedBox(height: 30,),
                Lottie.asset('assets/lottie/waveloop.json',
                    height: height * 0.2,
                    width: double.infinity,
                    fit: BoxFit.fill),
                const SizedBox(
  ...
  Future<void> savedLogin(UserModel model) async {
    ...
    prefs.setString("userGmail", emailController.text);
    prefs.setString("userPasword", passwordController.text);
